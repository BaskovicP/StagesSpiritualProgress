(() => {
  ...
  "hr": {
    ...
    "mortal-resistance-v4": "Pripremi jedan konkretan odgovor za poznatu napast: udaljiti se iz situacije, kratko se pomoliti ili potražiti pouzdanu pomoć. Neželjena misao sama po sebi nije pristanak.",
    ...
    "imperfections-watch-v4": "Izaberi jednu poznatu vezanost, primjerice potrebu za pohvalom. Primijeti je bez tjeskobnog nadziranja svake misli i jednom dnevno svjesno učini dobro bez isticanja sebe.",
    ...
    "suffering-peace-v4": "Kad se uznemiriš, napravi prostor za kratak predah i jednostavnu molitvu povjerenja. Zatim učini ono što danas možeš; mir ne znači da ne smiješ plakati ili tražiti pomoć.",
    ...
    "prayer-vocal-v4": {
      ...
      "4": "Zaštiti jednostavnu svakodnevnu praksu molitve usklađenu sa zdravljem i dužnostima. Ne treba dodavati mnogo riječi; važno je stvarno i vjerno obraćanje Bogu."
    },
    ...
    "sacraments-fervent-participation-v4": "Prije mise odaberi jednu jednostavnu nakanu. Tijekom slušanja i molitve mirno se vraćaj pažnji; žar nije mjera emocionalnog uzbuđenja.",
  ...
  "en": {
    ...
    "mortal-resistance-v4": "Prepare one concrete response to a familiar temptation: leave the situation, pray briefly or seek trusted support. An unwanted thought is not itself consent.",
    ...
    "imperfections-watch-v4": "Choose one known attachment, such as seeking praise. Notice it without anxiously monitoring every thought, and do a quiet good deed without drawing attention to yourself.",
    ...
    "suffering-peace-v4": "When distressed, make room for a brief pause and a simple prayer of trust. Then do what is possible today; peace does not forbid tears or seeking help.",
    ...
    "prayer-vocal-v4": {
      ...
      "4": "Protect a simple daily practice compatible with health and duties. More words are not the goal; a real and faithful turning to God is."
    },
    ...
    "sacraments-fervent-participation-v4": "Before Mass, choose one simple intention. While listening and praying, calmly return your attention; fervor is not measured by emotional excitement.",
    "imperfections-consent-v5": {
